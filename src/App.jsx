    ...
    <>
      ...
      <div style={{flex:1}}><Routes>
        <Route path="/" element={user?.role==="judge" && user?.judgeId && !search.trim()
          ...
          : !search.trim()
          ? /* ── Landing page ─────────────────────────────────────────── */
          (<div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"calc(100vh - 64px)",padding:"0 20px",textAlign:"center",overflow:"hidden"}}>
            ...
            {isMobile ? (
              <p style={{fontSize:13,color:T.textHint,margin:`0 0 ${isMobile?14:20}px`,letterSpacing:0.5}}>
                Find &nbsp;·&nbsp; Read &nbsp;·&nbsp; Book
              </p>
            ) : (
